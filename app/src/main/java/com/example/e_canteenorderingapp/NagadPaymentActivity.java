...
public class NagadPaymentActivity extends AppCompatActivity {
    ...
    private static final String TAG = "NagadPaymentActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d(TAG, "NagadPaymentActivity onCreate started");
        ...
        try {
            ...
            Toast.makeText(this, "Error initializing Nagad payment: " + e.getMessage(), Toast.LENGTH_LONG).show();
            finish();
        }
    }
    ...
    private void proceedToOTP() {
        try {
            ...
            intent.putExtra("payment_method", "Nagad");
